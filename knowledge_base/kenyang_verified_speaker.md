# Kenyang confirmed by a native speaker

Agbor Edouard Ransome, Bachou Ntai village, Manyu Division.

Everything in this file has been checked by a native speaker and outranks every other
source. Where a dictionary, a grammar guide or any other file disagrees with what is
written here, this wins.

---

## Word order in the noun phrase

Kenyang does NOT put every adjective in the same place. It depends on what kind of
adjective it is. This is the single most important rule in this file, because getting it
wrong produces sentences a Kenyang speaker would not say.

### Size, quality and shape come BEFORE the noun

    Ereme ɛkɛt          big house           (big + house)
    Ereme nsok          big elephant        (big + elephant)
    Mandu mmɔ           small child         (small + child)
    Mandu mmú           small dog           (small + dog)
    Erehti bhisi        beautiful face      (beautiful + face)
    erítí ɛkɛt          beautiful house     (beautiful + house)
    esaptí enok         long stick          (long + stick)
...
A grammar guide describing this construction used a colour as its example, which is why
a rule written only from that guide puts every adjective after the noun. That is correct
for colours and numbers, and wrong for size and quality.
...
### Size and quality
    ...
    Ereme               big
    Mandu               small
    Ninghe-Ninghe       very very small, tiny

Mandu is ordinary small — Mandu ɛkɛt is a small house. Ninghe-Ninghe is for very tiny
things, and is the word you would use affectionately with a small child.
...
### People and family
    ...
    mmá                 mother
    étá                 father
    mmɔ                 child          (also written mmo when showing pronunciation)
    mmochi              cousin or brother
...
### Saying things
    ...
    Mba'aaah            Hello
    néyi                good morning
    Máah                Yes, Mom      (answering your mother)
    Sáah                Yes, Dad      (answering your father or an elder)
    Èh!                 Yes
    Éh Èh!              No
    nnek                Please
    Oki ah              Thank you     — literally "you have done it"
    kaká                to greet
...
## Notes on spelling
    ...
    mmɔ / mmo           the same word; mmo is used when writing the pronunciation
    ntaŋ                correct spelling for moon
    Piór                the pronunciation used in the phrase ɛkɛt Piór, white house
